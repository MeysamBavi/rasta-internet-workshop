...
توی این مأموریت، معیار اصلی تعداد `Hop`هاست:
...
<iframe class="mini-game" src="../../games/routing/index.html" title="مینی‌گیم پر کردن جدول‌های مسیریابی" loading="lazy" allowfullscreen></iframe>
